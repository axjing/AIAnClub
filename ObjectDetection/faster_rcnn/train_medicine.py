...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="./resnet50-0676ba61.pth",
    ...
    if load_pretrain_weights:
        ...
        pretrain_path = "./backbone/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth"
...
def main(parser_data):
    ...
    if os.path.exists(os.path.join(VOC_root, "JPEGImages")) is False:
        raise FileNotFoundError("JPEGImage dose not in path:'{}'.".format(VOC_root))

    # load train data set
    # # VOCdevkit -> VOC2012 -> ImageSets -> Main -> train.txt
    # train_dataset = VOCDataSet(VOC_root, "2012", data_transform["train"], "train.txt")
    train_dataset = IADataset(VOC_root, data_transform["train"], "train.txt", json_file="./configurations/ct_class.json")
    train_sampler = None
    ...
    val_dataset = IADataset(VOC_root, data_transform["val"], "val.txt")
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录(VOCdevkit)
    parser.add_argument('--data-path', default='/home/jing/Coding/DATA/IAobj', help='dataset')
    # 检测目标类别数(不包含背景)
