...
def deeplabv3_resnet50(aux, out_channels=21, pretrain_backbone=False):
    ...
    if aux:
        aux_classifier = FCNHead(aux_inplanes, out_channels)

    classifier = DeepLabHead(out_inplanes, out_channels)
...
def deeplabv3_resnet101(aux, out_channels=21, pretrain_backbone=False):
...
def deeplabv3_mobilenetv3_large(aux, out_channels=21, pretrain_backbone=False):
...
if __name__=="__main__":
    print("TEST:  ->")
    model=deeplabv3_resnet50(False,out_channels=3)
    print(model)